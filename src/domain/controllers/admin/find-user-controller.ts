...
import { FindByIdUserRepository } from "../../services/repositories/user-repository";

@injectable()
export class FindUserController implements Controller {
    public constructor(@inject('UserRepository') private readonly userRepository: FindByIdUserRepository) { }
